<template>
  <div class="modal">
    ...
    >
      <div class="form">
        <el-form :model="formData" label-width="85px" size="large">
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button class="cancelBtn addBtn" @click="dialogVisible = false">取 消</el-button>
          <el-button class="colorBtn addBtn" type="primary" @click="handleConfirmClick">
            确 定
          </el-button>
        </span>
      </template>
